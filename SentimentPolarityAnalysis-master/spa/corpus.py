...
class DanmuCorpus(Corpus):
    def __init__(self):
        Corpus.__init__(self, "f_corpus/ch_danmu_corpus.txt")
...
def get_danmu_corpus():
    ...
    origin_filepath = ['f_corpus/danmu/negative_corpus_v1.txt',
                       'f_corpus/danmu/positive_corpus_v1.txt']
    corpus_filepath = "f_corpus/ch_danmu_corpus.txt"
